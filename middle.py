...
class DataProcessor:
    ...
    #         return data_model.count_vsads_by_date_range(*args)
    #     elif method == "calculate_average_by_hour_of_day":
    #         return data_model.calculate_average_by_hour_of_day()
    #     elif method == "filter_vsads_by_keywords":
    #         return data_model.filter_vsads_by_keywords(*args)
    #     elif method == "filter_vsads_by_alcohol":
    #         return data_model.filter_vsads_by_alcohol(*args)
    #     else:
